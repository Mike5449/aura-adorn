    ...
    <article className="group relative flex flex-col overflow-hidden border border-border/40 bg-card/40 transition-all duration-300 hover:-translate-y-1 hover:border-gold/60 hover:shadow-[0_8px_30px_rgba(212,175,55,0.12)]">
      ...
      <div className="relative">
        ...
        >
          ...
          {/* Price — overlaid on bottom-right of the image. The "/ unité"
              suffix appears only when the admin marked this product as
              having multiple units in the photo. */}
          <span
            className="absolute bottom-2 right-2 z-10 inline-flex items-baseline gap-1 rounded-sm bg-background/15 px-2.5 py-1 text-sm font-semibold text-gold shadow-sm backdrop-blur-lg sm:bottom-3 sm:right-3 sm:text-base"
